...
function Toolbar() {
  ...
  return (
    <>
      <button data-drawer-target="sidebar-multi-level-sidebar" data-drawer-toggle="sidebar-multi-level-sidebar" aria-controls="sidebar-multi-level-sidebar" type="button" className="inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
      ...
      <aside id="sidebar-multi-level-sidebar" className="sidebar fixed top-[80px] flex items-center left-0 z-40 transition-transform -translate-x-full sm:translate-x-0 border-r border-gray-200" aria-label="Sidebar">
        <div className="h-full px-3 py-4 overflow-y-auto">
          <ul className="space-y-2 font-medium">
            <li>
              <button className="toolbar-button" onDragStart={(event) => onDragStart(event, 'Message')} draggable>
                <img src="imgs/message-icon.png" alt="Message Icon" width={24} />
                <span>Message</span>
              </button>
            </li>
            <li>
              <button className="toolbar-button" onDragStart={(event) => onDragStart(event, 'Options')} draggable>
                <img src="imgs/options-icon.png" alt="Options Icon" width={24} />
            ...
            <li>
              <button className="toolbar-button" onDragStart={(event) => onDragStart(event, 'Input')} draggable>
                <img src="imgs/message-icon.png" alt="Input Icon" width={24} />
                <span>Input</span>
              </button>
            </li>
          </ul>
